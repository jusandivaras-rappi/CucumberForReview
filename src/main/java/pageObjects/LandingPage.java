...
public class LandingPage {
	...
	private By popup=By.xpath("//button[contains(.,'NO THANKS')]");
	private By register=By.xpath("(//span[contains(.,'Register')])[1]");
	
	public LandingPage(WebDriver driver) { //Constructor method
	...
	public int getPopUpSize() { //Method to know if the pop-up element is present in the UI or not (greater than o means that element is present)
